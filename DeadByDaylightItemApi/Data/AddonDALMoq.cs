...
namespace Data
{
    public class AddonDALMoq : Interface.IAddonContainer
    {
        ...
        {
            List<AddonDTO> addons = JsonSerializer.Deserialize<List<AddonDTO>>(File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory + @"\" + "addons.txt"));
            return addons;
        }
        ...
        public List<Interface.AddonDTO> GetAllAddons(string type)
        {
            ...
            File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + @"\" + "addons.txt",
                  JsonSerializer.Serialize(addonDTOs));
            return addonDTOs;
        }
